            ...
            <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <aside>
                        ...
                        <ul className="mt-8 flex gap-6 [&_li]:text-gray-300 [&_li]:hover:text-yellow-300">
                            <li>
                                <a
                                    href="#"
                                    rel="noreferrer"
                    ...
                    <section className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
                        <div>
                ...
                <p className="text-xs text-gray-300 ">
                    &copy; 2025. Virtual Shop. All rights reserved.
                </p>
            </div>
